...
delete from tbUsuario where email = "anap.1@hotmail.com";

delete from tbGrupo where codGrupo = 02;

delete from tbPermissao where nome = "Permissao 1";

delete from tbCidade where nome ="Rio De Janeiro";
